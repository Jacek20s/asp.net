<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="CodeFirst.Default" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:ObjectDataSource ID="ObjectDataSourceProdukty" runat="server" SelectMethod="PobierzProdukty" TypeName="CodeFirst.Modele.Repozytorium"></asp:ObjectDataSource>
        </div>
    </form>
</body>
</html>
